    ...
    try:
       await b.send_message(chat_id=m.chat.id,text="HELLO",quote=True)
                ...
                await b.send_message(
                    chat_id=m.chat.id,
                    text="file stream bot By [Mr Danger](https://t.me/mrdanger_xy)",
                    
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton("Developer💻", url=f"https://t.me/mrstrange_genuine")
                            ]
                        ]
                    ),
                    parse_mode="markdown",
       ...
       await b.send_message(chat_id=m.chat.id,text="HELLO",quote=True)
                ...
                await b.send_message(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton("FOLLOW ME", url=f"https://GITHUB.COM/satyanandatripathi")
                            ]
                        ]
                    ),
                    parse_mode="HTML",
    ...
    if usr_cmd == "start" or "/start":
        if Var.UPDATES_CHANNEL != "None":
            try:
                ...
                await b.send_message(
                    chat_id=m.chat.id,
                    text="<i>𝓢𝓸𝓶𝓮𝓽𝓱𝓲𝓷𝓰 𝔀𝓮𝓷𝓽 𝔀𝓻𝓸𝓷𝓰</i> <b> <a href='http://t.me/horneydevbot'>CLICK HERE FOR SUPPORT </a></b>",
                    parse_mode="HTML",
                    disable_web_page_preview=True)
                return
        await StreamBot.send_photo(
...
Send me any file and get a direct download link and streamable link.!""",
        ...
        if Var.UPDATES_CHANNEL != "None":
            try:
                ...
                await b.send_message(
                    chat_id=m.chat.id,
                    text="**Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ** [Satyanad](https://t.me/mrstrange_genuine)",
                    parse_mode="markdown",
                    disable_web_page_preview=True)
                return
...
async def help_handler(bot, message):
    ...
    if Var.UPDATES_CHANNEL is not None:
        try:
            ...
            await bot.send_message(
                chat_id=message.chat.id,
                text="__Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ__ Danger Network](https://t.me/horneydevbot).",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
...
<b> I also support Channels, add me to you Channel and send any media files and see miracle✨ also send /list to know all commands""",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("💁‍♂️ DEV", url="https://t.me/mrstrange_genuine")],
                [InlineKeyboardButton("💥 FOLLOW", url="https://GitHub.com/satyanandatripathi")]
            ]
        )
    )
